...
var _ShelterStore = require('../stores/ShelterStore');

var _ShelterStore2 = _interopRequireDefault(_ShelterStore);

var _ShelterActions = require('../actions/ShelterActions');

var _ShelterActions2 = _interopRequireDefault(_ShelterActions);
...
var Shelter = function (_React$Component) {
  _inherits(Shelter, _React$Component);
  ...
  function Shelter(props) {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Shelter).call(this, props));

    _this.state = _ShelterStore2.default.getState();
    _this.onChange = _this.onChange.bind(_this);
    return _this;
  }

  _createClass(Shelter, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      _ShelterStore2.default.listen(this.onChange);
      _ShelterActions2.default.getShelters();
    }
  }, {
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
      _ShelterStore2.default.unlisten(this.onChange);
    }
  }, {
    key: 'onChange',
    ...
    key: 'render',
    value: function render() {
      var shelters = this.state.shelters.map(function (shelter) {
        return _react2.default.createElement(
          'li',
          { key: shelter },
          _react2.default.createElement(
...
},{"../actions/ShelterActions":1,"../stores/ShelterStore":13,"react":"react","react-router":"react-router"}],9:[function(require,module,exports){
'use strict';
...
var _ShelterList = require('./components/ShelterList');

var _ShelterList2 = _interopRequireDefault(_ShelterList);

var _Signup = require('./components/Signup');

var _Signup2 = _interopRequireDefault(_Signup);

var _AdminSignup = require('./components/AdminSignup');

var _AdminSignup2 = _interopRequireDefault(_AdminSignup);

var _UserSignup = require('./components/UserSignup');
...
exports.default = _react2.default.createElement(
  ...
  _react2.default.createElement(_reactRouter.Route, { path: '/shelter', component: _ShelterList2.default }),
  _react2.default.createElement(_reactRouter.Route, { path: '/signup', component: _Signup2.default }),
  _react2.default.createElement(_reactRouter.Route, { path: '/user-signup', component: _UserSignup2.default }),
  _react2.default.createElement(_reactRouter.Route, { path: '/admin-signup', component: _AdminSignup2.default })
);

},{"./components/AdminSignup":3,"./components/App":4,"./components/Home":7,"./components/ShelterList":8,"./components/Signup":9,"./components/UserSignup":10,"react":"react","react-router":"react-router"}],13:[function(require,module,exports){
'use strict';
...
var ShelterStore = function () {
  function ShelterStore() {
    _classCallCheck(this, ShelterStore);

    this.bindActions(_ShelterActions2.default);
    this.shelters = [];
  }

  _createClass(ShelterStore, [{
    key: 'onGetSheltersSuccess',
    value: function onGetSheltersSuccess(data) {
      this.shelters = data;
    }
  }, {
    key: 'onGetSheltersFail',
    value: function onGetSheltersFail(jqXhr) {
      return jqXhr;
    }
  }]);
...
exports.default = _alt2.default.createStore(ShelterStore);

},{"../actions/ShelterActions":1,"../alt":2}],14:[function(require,module,exports){
