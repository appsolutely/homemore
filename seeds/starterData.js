...
//seeds insert order:
    ...
    knex('eligibilityOptions').insert([
            {
              eligibilityOption: "Age",
              eligibilityOptionDescription: "There is an age requirement for this shelter"
            },
            {
    ...
    .then(function(){
      ...
      knex('shelterEligibility').insert([
